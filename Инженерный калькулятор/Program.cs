...
do
{
    ...
    if (txt == "1")
    {
        ...
        int номер1 = int.Parse(Console.ReadLine());
        Console.WriteLine("Введите второе число: ");
        int номер2 = int.Parse(Console.ReadLine());
        int сумма = номер1 + номер2;
    ...
    else if (txt == "5")
    {
        ...
        int номер2 = int.Parse(Console.ReadLine());
        int степень = (int)Math.Pow(номер1, номер2);
